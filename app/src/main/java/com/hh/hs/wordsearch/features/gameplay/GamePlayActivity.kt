...
import com.hh.hs.wordsearch.commons.DurationFormatter.fromInteger
...
import com.hh.hs.wordsearch.custom.LetterBoard.OnLetterSelectionListener
import com.hh.hs.wordsearch.custom.StreakView.StreakLine
import com.hh.hs.wordsearch.features.FullscreenActivity
import com.hh.hs.wordsearch.features.SoundPlayer
...
import com.hh.hs.wordsearch.model.Difficulty
import com.hh.hs.wordsearch.model.GameData
import com.hh.hs.wordsearch.model.GameMode
import com.hh.hs.wordsearch.model.UsedWord
...
class GamePlayActivity : FullscreenActivity() {
    ...
    private fun fullScreenAd(){
        ...
        InterstitialAd.load(this,"ca-app-pub-8886884732302136/9083749883", adRequest, object : InterstitialAdLoadCallback() {
    ...
    private fun showFinishGame(state: Finished) {
        ...
        firebaseAnalytics.setUserProperty("id", "13242342354323431")

        firebaseAnalytics.logEvent(FirebaseAnalytics.Event.SELECT_ITEM) {
            param(FirebaseAnalytics.Param.ITEM_ID, "13242342354323431") // id
            param(FirebaseAnalytics.Param.ITEM_NAME, "23424244354363452") // what will be entered
            param(FirebaseAnalytics.Param.CONTENT_TYPE, "text") // type of entry
        }
    }
